...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-[#050d1b] text-white scroll-smooth overflow-auto font-sans">
      ...
      <main className="flex-grow">
        {/* ✅ Hero Section */}
        <header id="home" className="relative w-full h-screen flex items-center justify-center text-white px-4">
  <div className="flex flex-col md:flex-row items-center justify-between max-w-6xl w-full gap-10">
    ...
    <div className="z-10 w-full md:w-1/2 text-center md:text-left">
      <h2 className="text-6xl md:text-7xl font-extrabold leading-tight mb-6 animate-fadeIn">
        Powering the Future with <span className="text-[#00fff7]">AI</span>
      </h2>
      <p className="text-xl md:text-2xl text-gray-300 mb-8 animate-fadeIn delay-200">
        Software Development • AI Integration • Data Solutions • Talent Growth
      </p>
      <a
        href="#contact"
        className="px-8 py-4 bg-[#00fff7] hover:bg-[#00e6d6] text-black font-semibold text-lg rounded-full shadow-lg transition transform hover:scale-105 duration-300 animate-fadeIn delay-500"
      >
        Get Started
      </a>
    </div>
    ...
    <div className="relative w-full md:w-1/2 flex justify-center items-center">
      ...
      <img
        ...
        className="relative w-full max-w-sm animate-float z-10 glow-image"
      />
    </div>
  </div>

  {/* Scroll Down Arrow */}
  <a href="#about" className="absolute bottom-10 animate-bounce text-gray-300 hover:text-[#00fff7] transition duration-300">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
            ...
            <div className="flex flex-col justify-between">
              <div>
                ...
                <p className="mt-4 text-lg text-gray-300">
                  ...
                  <br /><br />
                  Our mission is to empower businesses with cutting-edge software, AI-driven automation, and robust data strategies, helping them optimize operations, enhance decision-making, and achieve long-term success.
                </p>
              </div>
              ...
              <div className="bg-[#1a1a2e]/40 p-6 rounded-lg shadow-md mt-6 backdrop-blur border border-[#00ffc2]/20">
                ...
                <ul className="mt-4 text-gray-100 list-disc list-inside space-y-2">
                  <li><span className="text-white font-semibold">Need a software solution for your business?</span> We develop web-based software and enterprise applications to streamline operations.</li>
                  <li><span className="text-white font-semibold">Want to integrate AI into your systems?</span> We embed AI, machine learning models, and automation into your applications for smarter functionality.</li>
                  <li><span className="text-white font-semibold">Looking to automate workflows?</span> We build AI-powered solutions to simplify processes and improve decision-making.</li>
                  <li><span className="text-white font-semibold">Dealing with large-scale data challenges?</span> We handle big data, time-series databases, and cloud architectures for efficient data management.</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="w-full py-20 bg-[#1a1a2e]/20 text-white text-center backdrop-blur">
          <div className="max-w-4xl mx-auto px-6">
            <h2 className="text-4xl md:text-5xl font-extrabold mb-4">Transforming Tomorrow with <span className="text-[#00ffc2]">AI</span></h2>
        ...
        {/* ✅ Why Choose Us */}
        <section id="why-us" className="px-10 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            {["A team of professionals with 10+ years of experience in Java, Spring Boot, Angular, React, and more.",
              ...
              "Our industry experts provide hands-on training for fresh talent, focusing on technology-specific and product-specific learning, ensuring they are project-ready from day one.",
              "We handle everything from software development and integration to scaling and support, ensuring 100% transparency, clear communication, and a client-first approach.",
              "We adapt to your needs with custom engagement models—project-based, dedicated teams, or long-term support."].map((desc, idx) => (
        ...
        {/* ✅ Contact Section */}
        <section id="contact" className="px-10 py-16 bg-[#1a1a2e]/40 text-center rounded-lg shadow-md mx-10 backdrop-blur border border-[#00ffc2]/20">
          <h2 className="text-4xl font-bold text-[#00ffc2]">Contact Us</h2>
          <p className="text-gray-300 mt-4">We’d love to hear from you! Reach out for inquiries and collaborations.</p>
          <ContactForm />
        </section>
      </main>
